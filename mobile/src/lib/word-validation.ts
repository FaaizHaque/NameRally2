...
export const WORD_DATABASE: Record<string, Record<string, string[]>> = {
  ...
  food_dishes: {
    A: ['Apple Pie', 'Alfredo', 'Arancini', 'Avocado Toast', 'Antipasto', 'Animal Crackers', 'Airheads'],
    B: ['Burrito', 'Burger', 'Biryani', 'Bruschetta', 'Brownies', 'Bacon', 'Bagel', 'Banana Bread', 'Baklava', 'BBQ', 'Beef Jerky', 'Bugles', 'Bounty Bar', 'Buñuelos'],
    C: ['Carbonara', 'Curry', 'Caesar Salad', 'Cake', 'Cheesecake', 'Chicken', 'Chili', 'Chips', 'Chocolate', 'Churros', 'Couscous', 'Croissant', 'Croquettes', 'Cheetos', 'Chips Ahoy', 'Corn Chips', 'Candy Corn', 'Caramel Corn'],
    D: ['Dumplings', 'Donut', 'Dal', 'Dim Sum', 'Doritos', 'Deep Fried Oreos'],
    E: ['Enchiladas', 'Eggs Benedict', 'Edamame', 'Empanadas', 'Elote', 'Esquites'],
    F: ['Fajitas', 'Fish and Chips', 'Fondue', 'French Fries', 'French Toast', 'Fried Rice', 'Frittata', 'Fries', 'Fritos', 'Funnel Cake', 'Ferrero Rocher'],
    G: ['Gnocchi', 'Grilled Cheese', 'Guacamole', 'Gumbo', 'Gyoza', 'Gyros', 'Gummy Bears', 'Gummy Worms', 'Graham Crackers', 'Goldfish Crackers', 'Granola Bar'],
    H: ['Hamburger', 'Hot Dog', 'Hummus', 'Hash Browns', 'Halo Halo', 'Hi-Chew'],
    I: ['Ice Cream', 'Irish Stew', 'Imagawayaki'],
    J: ['Jambalaya', 'Jelly', 'Jerky', 'Jalebi', 'Jolly Ranchers'],
    K: ['Kebab', 'Kimchi', 'Kung Pao Chicken', 'Kit Kat', 'Kettle Corn', 'Kinder Bueno'],
    L: ['Lasagna', 'Lemon Chicken', 'Lobster', 'Lo Mein', 'Lays Chips', 'Loaded Fries', 'Laffy Taffy'],
    M: ['Macaroni', 'Meatballs', 'Moussaka', 'Muffin', 'Miso Soup', 'M&Ms', 'Melonpan', 'Mixed Nuts', 'Mars Bar'],
    N: ['Nachos', 'Naan', 'Noodles', 'Nuggets', 'Nerds', 'Nutter Butter'],
    O: ['Omelette', 'Onion Rings', 'Orange Chicken', 'Oreos', 'Odeng'],
    P: ['Paella', 'Pancakes', 'Pasta', 'Pad Thai', 'Pho', 'Pizza', 'Pork Chops', 'Pot Roast', 'Pretzel', 'Pudding', 'Pocky', 'Pringles', 'Pork Rinds', 'Peanuts', 'Peach Rings', 'Pav Bhaji'],
    Q: ['Quesadilla', 'Quiche'],
    R: ['Ramen', 'Ravioli', 'Risotto', 'Ribs', 'Roast Beef', 'Roti', 'Rice Krispie Treats', 'Ritz Crackers', 'Ring Pops'],
    S: ['Salad', 'Salmon', 'Sandwich', 'Sashimi', 'Sausage', 'Soup', 'Spaghetti', 'Spring Rolls', 'Steak', 'Stew', 'Stir Fry', 'Sushi', 'Skittles', 'Slim Jim', 'Snickers Bar', 'Soft Pretzel', 'Starburst', 'String Cheese', 'Swedish Fish', 'Sour Patch Kids'],
    T: ['Taco', 'Tandoori', 'Tempura', 'Teriyaki', 'Tiramisu', 'Toast', 'Tofu', 'Tortilla', 'Turkey', 'Taiyaki', 'Takis', 'Tanghulu', 'Taho', 'Trail Mix', 'Toblerone', 'Twix', 'Twizzlers', 'Tootsie Roll'],
    U: ['Udon'],
    V: ['Vindaloo'],
    W: ['Waffle', 'Wings', 'Wonton', 'Wrap', 'Wasabi Peas', 'Wheat Thins'],
    X: ['Xiaolongbao'],
    Y: ['Yakitori', 'Yogurt', 'Yan Yan'],
...
export const validateConstraint = (
  ...
  switch (constraint.type) {
    ...
    case 'contains_vowel': {
      ...
      if (requiredVowel && !lettersOnly.toLowerCase().includes(requiredVowel)) {
        return {
          passes: false,
